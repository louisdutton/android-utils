...
class ComposeViewModel @Inject constructor(
    ...
    init {
        ...
        disposables += Observables.combineLatest(searchSelection, searchResults) { selected: Long, messages: List<Message> ->
            if (selected == -1L) {
    ...
    override fun bindView(view: ComposeView) {
        ...
        view.sendAsGroupIntent
            .observeOn(Schedulers.io())
            .withLatestFrom(conversation, state) { _: Unit, conversation: Conversation, state: ComposeState ->
        ...
        // clear the current message text and attachments
